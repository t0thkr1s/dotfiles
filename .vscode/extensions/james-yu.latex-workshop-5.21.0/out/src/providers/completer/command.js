...
class CommandCompletionItem extends vscode.CompletionItem {
    constructor(label, kind) {
        super(label, kind);
        this.packageName = undefined;
    }
}
exports.CommandCompletionItem = CommandCompletionItem;
class Command {
    ...
    initialize(defaultCommands, defaultEnvs) {
