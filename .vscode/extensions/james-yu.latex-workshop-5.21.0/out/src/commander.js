...
class Commander {
    ...
    build(skipSelection = false, recipe = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rootFile = yield this.extension.manager.findRoot();
    ...
    revealOutputDir() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.commands.executeCommand('revealFileInOS', vscode.Uri.file(outputDir));
        });
    }
    recipes(recipe) {
        ...
        vscode.window.showQuickPick(['Build LaTeX project', 'View LaTeX PDF', 'View log messages',
            ...
            switch (selected) {
                ...
                case 'Create an issue on Github':
                    vscode.commands.executeCommand('vscode.open', vscode.Uri.parse('https://github.com/James-Yu/LaTeX-Workshop/issues/new'));
                    break;
    ...
    */
    toggleSelectedKeyword(keyword, outerBraces) {
        const editor = vscode.window.activeTextEditor;
        if (editor === undefined) {
            return;
        }
        ...
        while (match !== null) {
            ...
            const insideText = structure_1.getLongestBalancedString(searchString);
